    ...
    >
      <div class="flex flex-col gap-2">
        <div
          ...
          :key="index"
          class="p-2 hover:bg-green-50 rounded"
        >
    ...
    >
      <div class="prose max-w-none">
        <p class="text-gray-700">
          Edit
          <code class="bg-white px-1 py-0.5 rounded border border-green-200"
            >src/pages/HomePage.vue</code
          >
          to customize this page. The application uses a Django backend with REST framework and a
